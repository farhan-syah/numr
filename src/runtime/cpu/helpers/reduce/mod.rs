...
mod tests {
    ...
    fn test_f32_fused_multi_dim_sum_is_bit_exact_sequential() {
        ...
        let a = Tensor::<CpuRuntime>::from_slice(&data, &[512, 1], &device);
    ...
    fn test_f16_fused_multi_dim_mean_does_not_saturate() {
        ...
        let a = Tensor::<CpuRuntime>::from_slice(&data, &[4096, 1], &device);
    ...
    fn test_bf16_non_last_dim_sum_does_not_saturate() {
        ...
        let a = Tensor::<CpuRuntime>::from_slice(&data, &[512, 3], &device);
