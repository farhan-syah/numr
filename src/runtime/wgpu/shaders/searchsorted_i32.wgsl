// Searchsorted operations for i32.
//
...
@group(0) @binding(0) var<storage, read_write> ss_seq: array<i32>;
@group(0) @binding(1) var<storage, read_write> ss_values: array<i32>;
...
fn searchsorted_i32(@builtin(global_invocation_id) global_id: vec3<u32>) {
    let idx = global_id.x;
