// Whole-tensor reductions for U32.
// Entry points: full_reduce_max_u32, full_reduce_min_u32
//
// There is deliberately no full-reduce sum or prod here. Those accumulate,
// so they must run in the wide accumulator that `reduce_int_acc_u32.wgsl`
