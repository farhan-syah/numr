...
pub(super) struct BroadcastBuffers {
    pub(super) a_strides: wgpu::Buffer,
    pub(super) b_strides: wgpu::Buffer,
    pub(super) out_strides: wgpu::Buffer,
    pub(super) params: wgpu::Buffer,
}

/// Build the stride and params buffers for a broadcast dispatch over `out_shape`.
pub(super) fn broadcast_buffers(
    client: &super::super::WgpuClient,
    a_shape: &[usize],
    b_shape: &[usize],
    out_shape: &[usize],
